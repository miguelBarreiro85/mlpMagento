...
foreach ($aSheet->getRowIterator() as $aRow){
    ...
    foreach ($aRow->getCellIterator() as $aCell) {
        ...
        switch ($aCell->getColumn()){
            ...
            //Descricao
            case 'B':
                $mSheet->setCellValue('B'.$split[0][1],$aCell->getValue());
                break;
            //Nome da marca
            case 'D':
    ...
    if($aRow->getRowIndex() == 100 || $aRow->getRowIndex() == 1000 || $aRow->getRowIndex() == 2000 || $aRow->getRowIndex() == 3000 || $aRow->getRowIndex() == 5000 ){
